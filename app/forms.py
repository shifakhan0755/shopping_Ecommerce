...
class LoginForm(AuthenticationForm):
    ...
    password = UsernameField(label=_("Password"),strip=True,widget=forms.PasswordInput(attrs={'autocomplete':'current-password','class':'form-control'}))

class MyPasswordChange(PasswordChangeForm):
    old_password = forms.CharField(label=("Old Password"),strip=True,widget=forms.PasswordInput(attrs={'autocomplete': 'current-password','autofocus':True,'class':'form-control'}))
